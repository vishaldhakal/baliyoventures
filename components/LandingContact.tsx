                ...
                >
                  <div className="space-y-6">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="relative">
                          <FormLabel className="absolute -top-2 left-4 px-1 text-xs text-[#F0D100] bg-[#111111] z-10">
                            Name
                          </FormLabel>
                          <FormControl>
                            <Input
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem className="relative">
                          <FormLabel className="absolute -top-2 left-4 px-1 text-xs text-[#7D7D7D] bg-[#111111] z-10">
                            Phone Number
                          </FormLabel>
                          <FormControl>
                            <Input
