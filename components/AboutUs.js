          ...
          <div className="col-12 col-lg-6 col-xl-7">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                <h2 className="fs-1 mb-3 main-title">Who Are We?</h2>
                <p className="mb-3 text-mine2">
                  Providing Solutions For All Your Tech Needs
                </p>
                <p className="mb-5">
                ...
                <div className="row gy-4 gy-md-0 gx-xxl-5X">
                    ...
                    <div className="d-flex">
                      ...
                      <div>
                        ...
                        <p className="text-secondary mb-0">
                          Choosing Baliyo Ventures means partnering with a team
                          of experts who are dedicated to your success.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-md-6">
                    <div className="d-flex">
                      ...
                      <div>
                        <h4 className="mb-3">How are we different?</h4>
                        <p className="text-secondary mb-0">
                          We set ourselves apart through our commitment to
